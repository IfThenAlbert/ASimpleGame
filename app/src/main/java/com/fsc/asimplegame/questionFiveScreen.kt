...
class questionFiveScreen : AppCompatActivity() {
     var selectedANswer: String = ""

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_question_five_screen)
    }
        ...
        dialogBuilder.setMessage("You sure about that?")
            ...
            .setPositiveButton("Proceed", DialogInterface.OnClickListener {
                ...
                with (sharedPref.edit()) {
                    putString("answer5", selectedANswer)

                    apply()
                }
                Log.d("ff",selectedANswer);

                startActivity(Intent(applicationContext,ResultScreen::class.java))
            })
