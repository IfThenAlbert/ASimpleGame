...
class questionFourScreen : AppCompatActivity() {
    var selectedANswer:String = ""

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_question_four_screen)
    }
        ...
        dialogBuilder.setMessage("You sure about that?")
            ...
            .setPositiveButton("Proceed", DialogInterface.OnClickListener {
                ...
                with (sharedPref.edit()) {
                    putString("answer4", selectedANswer)
                    apply()
                }

                startActivity(Intent(applicationContext,questionFiveScreen::class.java))
            })
