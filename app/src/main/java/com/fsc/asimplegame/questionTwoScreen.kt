...
class questionTwoScreen : AppCompatActivity() {
    var selectedANswer:String = ""

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_question_two_screen)
    }
        ...
        dialogBuilder.setMessage("You sure about that?")
            ...
            .setPositiveButton("Proceed", DialogInterface.OnClickListener {
                ...
                with (sharedPref.edit()) {
                    putString("answer2", selectedANswer)
                    apply()
                }

                startActivity(Intent(applicationContext,questionThreeScreen::class.java))
            })
