...
class questionOneScreen : AppCompatActivity() {
    var selectedANswer:String = ""

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_question_one_screen)
        ...
        dialogBuilder.setMessage("You sure about that?")
            ...
            .setPositiveButton("Proceed", DialogInterface.OnClickListener {
                ...
                with (sharedPref.edit()) {
                    putString("answer1", selectedANswer)
                    apply()
                }

                startActivity(Intent(applicationContext,questionTwoScreen::class.java))
            })
